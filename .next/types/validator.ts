...
// Validate ../../app/api/race-results/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/race-results">> = Specific
  const handler = {} as typeof import("../../app/api/race-results/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
